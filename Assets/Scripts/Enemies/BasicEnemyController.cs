...
public class BasicEnemyController : MonoBehaviour
{
    ...
    [Header("Managers")]
    [SerializeField] private Destroyable destroyable = null;
    
    [Header("Explosions")]
    [SerializeField] private GameObject explosionPrefabObject = null;
    [SerializeField] private GameObject explosionPrefabEnemy = null;
    ...
    [SerializeField] public bool isOjbect = true;

    private void Start()
    {
        if (isOjbect == true) return;
    ...
    private void OnEndSplit(List<Destroyable> clones)
	{
        ...
        for (ushort i = 0; i < clones.Count; i++)
		{
			...
			if (rigidbody != null)
			{
                ...
                //rigidbody.AddForce(vector * 1000, ForceMode2D.Force);

                rigidbody.AddForce(Vector2.right * 200, ForceMode2D.Impulse);

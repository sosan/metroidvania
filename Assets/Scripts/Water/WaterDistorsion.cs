...
public class WaterDistorsion : MonoBehaviour
{
    ...
    [SerializeField] private string shader = "Custom/Water";
...
#if UNITY_EDITOR
[CustomEditor(typeof(WaterDistorsion)), CanEditMultipleObjects]
public class WaterDistorsion_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        WaterDistorsion waterScript = (WaterDistorsion)target;
        ...
        if (waterScript.ForceMaterial == null)
        {
            waterScript.ActiveChange = true;
        }
        else
        {
            if (GUILayout.Button("Remove Shared Material"))
            {
                waterScript.ForceMaterial = null;
                waterScript.ShaderChange = 1;
                waterScript.ActiveChange = true;
                waterScript.CallUpdate();
            }

            EditorGUILayout.PropertyField(m_object.FindProperty("ActiveChange"), new GUIContent("Change Material Property", "Change The Material Property"));
        }

        if (waterScript.ActiveChange)
        {

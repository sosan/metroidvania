...
namespace DestroyableObject
{
	...
	public struct DestroyableRect
	{
		...
		public static DestroyableRect CreateFromMinSize(int minX, int minY, int sizeX, int sizeY)
		{
			var o = default(DestroyableRect);
		...
		public DestroyableRect(int newMinX, int newMaxX, int newMinY, int newMaxY)
		{
